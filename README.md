...
### 1. 🎼 **Beat Sheet Generator - Outil de génération de fiches musicales**
...
- Génération de fiches ou structures de travail pour des projets musicaux
- Centralisation d'informations utiles à la composition et à l'organisation
- Base pratique pour faire évoluer des workflows de production assistée
- Expérimentations autour du **parsing**, de la génération **PDF** et des métadonnées

---

### 2. 📄 **PPPDF - Génération PDF pro, conformité & signatures**
...
- Génération de PDF avec logique métier et contrôle des métadonnées
- Validation de conformité autour de **PDF/A** et **Factur-X**
- Exploration des signatures électroniques, du hachage, de la PKI et des formats CMS
- Vérification documentaire avec **VeraPDF** dans une logique qualité / audit
